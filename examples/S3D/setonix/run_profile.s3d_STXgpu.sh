...
#module load gcc/11.2.0 omnitrace/1.10.0
#export PATH=$PATH:/software/setonix/2022.11/custom/software/zen3/gcc/12.1.0/omnitrace/1.10.0/bin
#export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/software/setonix/2022.11/custom/software/zen3/gcc/12.1.0/omnitrace/1.10.0/lib/:/software/setonix/2022.11/pawsey/software/rocm/rocm-5.4.3rev1/lib
#OMNITRACE="/software/setonix/2022.11/custom/software/zen3/gcc/12.1.0/omnitrace/1.10.0/bin/omnitrace"
...
#omnitrace-instrument -o ./s3d.STXgpu.x.inst -- ./s3d.STXgpu.x

# Straight run of the code
#srun -u -n $SLURM_NTASKS -c 8 ./s3d.STXgpu.x

# Run for hotspot profile
#srun -n $SLURM_NTASKS -c 8 rocprof --stats ./s3d.STXgpu.x
srun -n $SLURM_NTASKS -c 8 rocprof --sys-trace ./s3d.STXgpu.x
