...
ncu -o profile1.ncu-rep --log-file log1.log --nvtx \
  --nvtx-include "N9LAMMPS_NS18PairComputeFunctorINS_23PairLJCutCoulLongKokkosIN6Kokkos4CudaEEELi1ELb1ENS_13CoulLongTableILi1EEEEE/" \
